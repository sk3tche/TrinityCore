...
enum SpellAttr2
{
    ...
    SPELL_ATTR2_CANT_HIT_MAGNET                  = 0x00400000, // 22 will never hit magnet target such as grounding totem
...
enum SpellAttr3
{
    ...
    SPELL_ATTR3_CANT_MISS                        = 0x00040000, // 18 Spell will always hit its target.
...
inline bool IsArenaTypeValid(ArenaType type)
{
    return type == ARENA_TYPE_2v2 || type == ARENA_TYPE_3v3 || type == ARENA_TYPE_5v5;
}
