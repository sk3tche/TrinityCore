    ...
    if (isArena() && isRated())
    {
        ...
        if (winner_arena_team && loser_arena_team && winner_arena_team != loser_arena_team)
        {
            if (winner != WINNER_NONE)
            {
                ...
                winner_change = winner_arena_team->CalculateRatingChange(winner_team_rating, loser_team_rating, true);
                loser_change = loser_arena_team->CalculateRatingChange(winner_team_rating, loser_team_rating, false);
